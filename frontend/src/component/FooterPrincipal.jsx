      ...
      <footer className="footer has-background-danger has-text-danger-light columns is-12">
        ...
        <div className="column is-6 mr-4">
          ...
          <aside className="is-medium menu has-text-left">
            ...
            <h3 className="title has-text-black"><b>Proxipyme</b></h3>
            {/* Se indica un texto de color negro y un parrafo con texto blanco */}
            <p className="menu-label has-text-white">
              Proxipyme nace tras un analisis sobre las limitaciones de las pequeñas y medianas empresas,
              esta es una plataforma que busca que las pymes puedan destacar en el mercado digital.
            </p>
          </aside>
        </div>
        ...
        <div className="column is-3">
          ...
          <aside className="is-medium menu has-text-left">
            {/* Se indica un texto de color negro y un parrafo con texto blanco */}
            <h3 className="title has-text-black"><b>Redes Sociales</b></h3>
            {/* Se indica un texto de color negro y un parrafo con texto blanco */}
            <p className="menu-label has-text-white">
              {/* Cada "a" redirecciona hacia alguna red social indicada con su respectivo icono */}
              <a className="has-text-white" href="https://www.twitter.com/"><i className="fab fa-twitter mr-2"></i> Twitter</a><br />
              <a className="has-text-white" href="https://www.instagram.com/"><i className="fab fa-instagram mr-2"></i> Instagram</a><br />
              <a className="has-text-white" href="https://www.facebook.com/"><i className="fab fa-facebook mr-2"></i> Facebook</a><br />
              <a className="has-text-white" href="https://www.github.com/"><i className="fab fa-github mr-2"></i> Github</a>
            </p>
          </aside>
        </div>
      </footer>
